...
URL Link to lab : https://www.freecodecamp.org/learn/javascript-v9/lab-all-true-property-validator/build-an-all-true-property-validator

js file name: truthy-check.js
