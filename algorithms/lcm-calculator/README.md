...
URL Link to lab : https://www.freecodecamp.org/learn/javascript-v9/lab-range-based-lcm-calculator/implement-a-range-based-lcm-calculator

js file name: lcm-calculator.js
