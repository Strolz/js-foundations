...
Your function should return a string which represents a randomly generated password. You should use the following string and different Math methods to help you return a new string with random characters in it:
...
URL Link to lab : https://www.freecodecamp.org/learn/javascript-v9/lab-password-generator/lab-password-generator

js file name: password-generator.js
