...
Objective: Fulfill the user stories and get all the tests to pass so the lab is functioning properly.
---------------------------------
...
URL Link to lab : https://www.freecodecamp.org/learn/javascript-v9/lab-random-background-color-changer/debug-a-random-background-color-changer
