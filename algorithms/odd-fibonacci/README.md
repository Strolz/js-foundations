...
URL Link to lab :https://www.freecodecamp.org/learn/javascript-v9/lab-odd-fibonacci-sum-calculator/build-an-odd-fibonacci-sum-calculator

js file name: odd-fibonacci.js
